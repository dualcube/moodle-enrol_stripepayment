...
$string['mailmanagers'] = 'Notify managers';
$string['mailmanagers_desc'] = 'Also send the enrolment notification to users holding the Manager role (or a role using the Manager archetype), including those assigned at the category or site level.';
