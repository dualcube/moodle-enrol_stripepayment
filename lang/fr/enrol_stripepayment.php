 ...
 * @copyright  2019 Dualcube, Arkaprava Midya, Parthajeet Chakraborty, Louis Bronne
...
$string['btntext']= 'Payer par carte';
...
$string['stripeaccepted'] = "Paiement Stripe accepté";
...
$string['validatezipcode_desc'] = "Activer l'option de paiement Stripe qui indique si l'adresse de facturation doit être vérifiée durant le processus de paiement. Stripe recommande fortement cette option afin de réduire les fraudes.";
$string['maxenrolled'] = "Nombre maximum d'utilisateurs inscrits";
$string['maxenrolled_help'] = "Précise le nombre maximum d'utilisateurs qui peuvent s'inscrire via Stripe. 0 indique l'absence de limite.";
$string['maxenrolledreached'] = "Le nombre maximum d'utilisateurs via l'inscription Stripe a été atteint.";
...
$string['error_with_stripe'] = "Le paiement n'est pas possible en raison d'un problème technique (problème avec Stripe)";