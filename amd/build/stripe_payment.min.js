define(['jquery', 'core/ajax'],
    function ($, ajax) {
        return {
            stripe_payment: function (amount, couponid, instance_id, please_wait_string, buy_now_string, invalid_code_string) {
                // coupon js code
                ...
                if (get_card_zero_cost) {
                    get_card_zero_cost.click(function () {
                        var promises = ajax.call([{
                            ...
                            args: { couponid: couponid, instance_id: instance_id },
                        }]);
                        promises[0].then(function (data) {
                            location.reload();
                        }).fail(function (ex) {
                ...
                if (buyBtn) {
                    buyBtn.click(function () {
                        ...
                        var promises = ajax.call([{
                            ...
                            args: { amount: amount, couponid: couponid, instance_id: instance_id },
                        }]);
                        promises[0].then(function (data) {
                            if (data.status) {
