...
require('Stripe/version3api.php');
...
$get_cost_from_plugin = $plugin->get_config('cost');
$course_id = $course->id;
$invalid_code_string = get_string("invalidcouponcode", "enrol_stripepayment");
$PAGE->requires->js_call_amd('enrol_stripepayment/coupon_js', 'debug', array($course_id, $secret_key, $get_cost_from_plugin, $invalid_code_string));
?>
<div align="center">
...
$_SESSION['amount'] = enrol_get_plugin('stripepayment')->get_stripe_amount($cost, $_SESSION['currency'], false);
...
$email = $USER->email;
$PAGE->requires->js_call_amd('enrol_stripepayment/free_enrol', 'debug', array($cost, $couponid, $user_id, $course_id, $instance_id, $email));
} else { ?>
...
<?php
$paymentintendsca_link = $CFG->wwwroot. '/enrol/stripepayment/paymentintendsca.php';
...
$user_id = $USER->id;
$instance_id = $instance->id;
$please_wait_string = get_string("please_wait", "enrol_stripepayment");
$buy_now_string = get_string("buy_now", "enrol_stripepayment");
$PAGE->requires->js_call_amd('enrol_stripepayment/stripe', 'debug', array($paymentintendsca_link, $publishablekey, $secret_key, $courseid, $amount, $currency, $description, $couponid, $user_id, $instance_id, $please_wait_string, $buy_now_string));
 } ?>
