...
class moodle_enrol_stripepayment_external extends external_api {
    ...
    public static function stripe_js_method_parameters() {
        return new external_function_parameters(
            array(
                'paymentintendsca_link' => new external_value(PARAM_RAW, 'The item id to operate on'),
                'publishablekey' => new external_value(PARAM_RAW, 'Update publishablekey'),
    ...
    public static function stripe_js_method($paymentintendsca_link, $publishablekey, $secret_key, $courseid, $amount, $currency, $description, $couponid, $user_id, $instance_id) {
